 ...
 *  - accentColor?: string — primary accent (defaults to #8B5CF6 for Pinnacle)
 */
const AttendanceCalendar = ({ records = [], onToggleDate, readOnly = false, showFullYear = false, accentColor = '#8B5CF6' }) => {
