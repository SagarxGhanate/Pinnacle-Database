...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 relative overflow-hidden">
      {/* Subtle Radial Glow */}
      <div className="fixed bottom-[-300px] left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(109,40,217,0.15)_0%,rgba(109,40,217,0)_70%)] pointer-events-none z-0"></div>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#0e0e0e]">
          <div className="flex flex-col items-center animate-fadeIn">
            ...
            <div className="w-20 h-20 rounded-full bg-[#8B5CF6]/10 flex items-center justify-center mb-6 border-2 border-[#8B5CF6]/30 relative">
              <div className="absolute inset-0 rounded-full bg-[#8B5CF6]/5 animate-ping"></div>
              <span className="material-symbols-outlined text-[40px] text-[#8B5CF6] relative z-10">check_circle</span>
            </div>
      ...
      <main className="relative z-10 w-full max-w-[400px]">
        <div className="bg-[#1a1a1a] border border-[rgba(255,255,255,0.07)] rounded-[16px] px-[24px] py-[32px] w-full">
          ...
          <div className="mb-8 text-center sm:text-left">
            ...
            <h1 className="font-display-lg text-[28px] leading-tight tracking-tight text-white mb-1">
              Pinnacle <span className="text-[#8B5CF6]">Forge</span>
            </h1>
            <p className="font-body-md text-[13px] text-[#A78BFA] font-medium">
              Peak Performance Admin Portal
            </p>
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex justify-between items-center mt-1">
                ...
                <Link to="/forgot-password" className="font-body-md text-[13px] text-[#8B5CF6] hover:text-[#A78BFA] transition-colors font-medium">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6 flex flex-col items-center gap-2">
            <div>
              ...
              <Link to="/signup" className="font-body-md text-[13px] text-[#8B5CF6] hover:text-[#A78BFA] transition-colors font-bold">
                Sign Up
              </Link>
            </div>
          </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-6 opacity-30">
          <div className="flex items-center gap-2">
            ...
            <span className="font-label-sm text-label-sm text-on-surface">Pinnacle Security</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="material-symbols-outlined text-[16px] text-on-surface">terminal</span>
            <span className="font-label-sm text-label-sm text-on-surface">v2.0 Forge</span>
          </div>
        </div>
      </main>
    </div>
