              ...
              <div className={`flex items-center gap-2 px-4 py-2 rounded-full text-[13px] font-bold transition-all ${
                ...
                {i < step ? (
                  ...
                  <span className="w-5 h-5 rounded-full border-2 flex items-center justify-center text-[11px] font-bold" style={{
                    borderColor: i === step ? '#8B5CF6' : '#3A3A4A',
                    color: i === step ? '#8B5CF6' : '#3A3A4A',
                  }}>
                    {i + 1}
                  </span>
                )}
          ...
          <div className="space-y-6 animate-fadeIn">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left bg-[#1a1a1a] border rounded-xl p-4 flex items-center gap-4 transition-all active:scale-[0.98] ${
                        isSelected
                          ? 'border-primary-container/40 bg-primary-container/5 shadow-[0_0_20px_rgba(139,92,246,0.05)]'
            ...
            {selectedIds.size > 0 && (
              <div className="sticky bottom-20 z-40">
                <button
                  onClick={() => setStep(1)}
                  className="w-full sm:w-auto float-right px-8 py-3.5 bg-gradient-to-r from-[#8B5CF6] to-[#6D28D9] text-white rounded-xl font-bold text-[14px] hover:brightness-110 active:scale-[0.98] transition-all shadow-[0_8px_30px_rgba(139,92,246,0.25)] flex items-center gap-2"
                >
                  Next: Select Date
