      ...
      <main className="pt-6 px-4 max-w-2xl mx-auto space-y-5">
        ...
        <section className="rounded-2xl overflow-hidden bg-[#1a1a1a] border border-white/[0.06]">
          ...
          <div className="h-[140px] relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#8B5CF6]/30 via-[#6D28D9]/15 to-[#0e0e0e]/80"></div>
          ...
          <div className="px-6 pb-6 flex flex-col items-center text-center -mt-[80px] relative z-10">
            ...
            {member.avatar ? (
              ...
              <div className="w-[160px] h-[160px] rounded-full bg-gradient-to-br from-[#8B5CF6]/20 to-[#6D28D9]/10 border-[6px] border-[#1a1a1a] flex items-center justify-center shadow-xl">
        ...
        {!isViewer && (
          <section className="rounded-2xl bg-[#1a1a1a] border border-white/[0.06] p-6">
            ...
            <div className="space-y-3">
              <button 
                onClick={() => navigate(`/members/${id}/edit`)}
                className="w-full h-[44px] bg-gradient-to-r from-[#8B5CF6] to-[#6D28D9] text-white rounded-xl font-medium text-[14px] hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[rgba(249,115,22,0.15)]"
              >
