        ...
        <div className={`rounded-3xl p-8 relative overflow-hidden transition-colors duration-300 ${isDark ? 'bg-[#1a1a1a] border border-[rgba(255,255,255,0.05)] shadow-[0_10px_40px_rgba(0,0,0,0.3)]' : 'bg-white border border-[rgba(0,0,0,0.06)] shadow-[0_4px_20px_rgba(0,0,0,0.06)]'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <select className={`h-[44px] rounded-xl px-4 text-[14px] outline-none appearance-none cursor-pointer transition-all focus:ring-2 focus:ring-[#8B5CF6]/20 focus:border-[#8B5CF6] ${isDark ? 'bg-[#262626] border border-[rgba(255,255,255,0.08)] text-white' : 'bg-[#F0F0F5] border border-[rgba(0,0,0,0.08)] text-[#1a1a2e]'}`}>
          ...
          <div className="mt-8 flex justify-end gap-3 relative z-10">
            ...
            <button className="px-6 py-2.5 bg-[#8B5CF6] hover:bg-[#e85a0d] active:scale-[0.98] transition-all rounded-xl text-[14px] font-medium text-white shadow-[0_4px_14px_rgba(255,107,26,0.4)]">
              Save Changes
            </button>
          </div>
        </div>
