      ...
      <main className="w-full max-w-[800px] mx-auto px-4 py-8 pb-24 animate-fadeIn">
        ...
        <div className="flex flex-col items-center mb-10 text-center">
          <div className="relative group cursor-pointer mb-6">
            <div className={`w-[120px] h-[120px] rounded-full overflow-hidden border-[3px] shadow-[0_0_30px_rgba(255,107,26,0.15)] transition-transform duration-300 group-hover:scale-105 ${isDark ? 'border-[#8B5CF6]/40' : 'border-[#8B5CF6]/30'}`}>
              <img 
            ...
            <div className={`absolute -bottom-1 -right-1 w-9 h-9 rounded-full flex items-center justify-center shadow-lg border-[3px] bg-[#8B5CF6] ${isDark ? 'border-[#0e0e0e]' : 'border-[#F5F5F7]'}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-10">
          <div className={`rounded-2xl p-5 flex flex-col items-center justify-center transition-colors hover:border-[#8B5CF6]/20 ${isDark ? 'bg-[#1a1a1a] border border-[rgba(255,255,255,0.05)] shadow-[0_8px_20px_rgba(0,0,0,0.2)]' : 'bg-white border border-[rgba(0,0,0,0.06)] shadow-[0_2px_10px_rgba(0,0,0,0.04)]'}`}>
            <span className="material-symbols-outlined text-[#8B5CF6] text-[28px] mb-2">shield_person</span>
          ...
          <div className={`rounded-2xl p-5 flex flex-col items-center justify-center transition-colors hover:border-[#8B5CF6]/20 col-span-2 md:col-span-1 ${isDark ? 'bg-[#1a1a1a] border border-[rgba(255,255,255,0.05)] shadow-[0_8px_20px_rgba(0,0,0,0.2)]' : 'bg-white border border-[rgba(0,0,0,0.06)] shadow-[0_2px_10px_rgba(0,0,0,0.04)]'}`}>
        ...
        <form onSubmit={handleSave} className={`rounded-3xl p-8 relative overflow-hidden transition-colors duration-300 ${isDark ? 'bg-[#1a1a1a] border border-[rgba(255,255,255,0.05)] shadow-[0_10px_40px_rgba(0,0,0,0.3)]' : 'bg-white border border-[rgba(0,0,0,0.06)] shadow-[0_4px_20px_rgba(0,0,0,0.06)]'}`}>
          ...
          <div className={`absolute top-0 right-0 w-[300px] h-[300px] rounded-full blur-[80px] pointer-events-none ${isDark ? 'bg-[#8B5CF6]/5' : 'bg-[#8B5CF6]/3'}`}></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                className={`h-[44px] rounded-xl px-4 text-[14px] outline-none transition-all focus:ring-2 focus:ring-[#8B5CF6]/20 focus:border-[#8B5CF6] ${isDark ? 'bg-[#262626] border border-[rgba(255,255,255,0.08)] text-white' : 'bg-[#F0F0F5] border border-[rgba(0,0,0,0.08)] text-[#1a1a2e]'}`}
                required
              />
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                className={`h-[44px] rounded-xl px-4 text-[14px] outline-none transition-all focus:ring-2 focus:ring-[#8B5CF6]/20 focus:border-[#8B5CF6] ${isDark ? 'bg-[#262626] border border-[rgba(255,255,255,0.08)] text-white placeholder:text-[#555]' : 'bg-[#F0F0F5] border border-[rgba(0,0,0,0.08)] text-[#1a1a2e] placeholder:text-[#aaa]'}`}
              />
            </div>
            <div className="flex flex-col gap-2">
              ...
              <select 
                ...
                className={`h-[44px] rounded-xl px-4 text-[14px] outline-none appearance-none cursor-pointer transition-all focus:ring-2 focus:ring-[#8B5CF6]/20 focus:border-[#8B5CF6] ${isDark ? 'bg-[#262626] border border-[rgba(255,255,255,0.08)] text-white' : 'bg-[#F0F0F5] border border-[rgba(0,0,0,0.08)] text-[#1a1a2e]'}`}
              >
          ...
          <div className="mt-8 flex justify-end gap-3 relative z-10">
            ...
            <button 
              type="submit"
              disabled={saving}
              className="px-6 py-2.5 bg-[#8B5CF6] hover:bg-[#7c3aed] active:scale-[0.98] transition-all rounded-xl text-[14px] font-medium text-white shadow-[0_4px_14px_rgba(139,92,246,0.4)] disabled:opacity-50"
            >
